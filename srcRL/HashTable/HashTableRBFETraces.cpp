...
void HashTableRBFETraces::updateETraces(CAction *action, CActionData *data)
{
...
void HashTableRBFETraces::addETrace(CStateCollection *state, CAction *action, double factor, CActionData *data) 
{
//		_currentState = state;
...
void HashTableRBFETraces::updateQFunction(double td)
{
//    DebugPrint('e',"\n[+] Q-Function update\n");
    if (td == 0.)
        return;
...
void HashTableRBFETraces::resetETraces()
{
    _eTraces.clear();
    _actions.clear();
    _eTraceStates.clear();
