...
namespace MultiBoost {
	...
	typedef pair< AlphaReal, bLearnerAndIndexSet> EdgeAndBaseLearnerType;
	typedef pair< AlphaReal, vector< EdgeAndBaseLearnerType > > EdgeBaseLearnerVector;
