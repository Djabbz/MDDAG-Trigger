...
/**
* \file ProductLearner.h A single threshold decision stump learner. 
* \date 24/04/2007
*/

#ifndef __PRODUCT_LEARNER_H
#define __PRODUCT_LEARNER_H
...
*/
class ProductLearner : public BaseLearner
{
public:
   ...
   * \date 26/05/2007
   */
   ProductLearner() : _numBaseLearners(-1) { }

   /**
   * The destructor. Must be declared (virtual) for the proper destruction of 
   * the object.
   */
   virtual ~ProductLearner() {
   ...
   * \date 14/11/2005
   */
   virtual BaseLearner* subCreate() { return new ProductLearner(); }
