...
/**
* \file ProductLearnerUCT.h A single threshold decision stump learner. 
* \date 24/04/2007
*/
...
namespace MultiBoost {
	...
	*/
	class ProductLearnerUCT : public BaseLearner
	{
	public:
		...
		* \date 26/05/2007
		*/
		ProductLearnerUCT() : _numBaseLearners(-1) { }

		/**
		* The destructor. Must be declared (virtual) for the proper destruction of 
		* the object.
		*/
		virtual ~ProductLearnerUCT() {
		...
		* \date 14/11/2005
		*/
		virtual BaseLearner* subCreate() { return new ProductLearnerUCT(); }
		...
		* \see load
		* \see classify
		* \see ProductLearnerUCT::run()
		* \date 25/05/2007
		*/
		virtual void subCopyState(BaseLearner *pBaseLearner);

		virtual void createUCTTree() {
			const int numColumns = _pTrainingData->getNumAttributes();

			_root.createRecursiveUCTTree( _numBaseLearners, numColumns );
		}

		virtual void clearUCTTree() {
